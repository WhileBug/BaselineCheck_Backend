...
public class Host2taskController {
    ...
    @ApiOperation(value = "获取检查结果的接口",notes = "获取检查结果的接口",httpMethod = "GET")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "taskId",value = "任务编号主键",paramType = "query",dataType = "String",required = true)
    })
    public Map<String, Object> getCheckResult(String taskId) {
        return this.host2taskServiceImpl.getCheckResult(taskId);
    }

    @RequestMapping(value = "/getAnalysisResult", method = RequestMethod.GET)
    @ApiOperation(value = "获取检查统计分析结果的接口",notes = "获取检查统计分析结果的接口",httpMethod = "GET")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "taskId",value = "任务编号主键",paramType = "query",dataType = "String",required = true)
    })
    public Map<String, Object> getAnalysisResult(String taskId) {
        return this.host2taskServiceImpl.getAnalysisResult(taskId);
    }
