...
public class HostsServiceImpl {
    ...
    public Map<String, Object> selectForCount(String name) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("list", this.hostsMapper.selectForCount(name));
        return map;
    }
    ...
    public Map<String, Object> selectAll() {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("list", this.hostsMapper.selectAll());
        return map;
    }
    ...
    public Map<String, Object> selectById(Integer hostId) {
        ...
        map.put("code", 200);
        map.put("msg", "查询成功");
        map.put("obj", this.hostsMapper.selectById(hostId));
        return map;
    }
    ...
    // 获取当前表中的总记录
        int tableCount = this.hostsMapper.selectForCount(name);
        ...
        map.put("data", this.hostsMapper.selectForPage(index, name));
        return map;
    }
     ...
     * @return 实例对象
     */
    public Map<String, Object> insert(Hosts hosts) {
     ...
     * @return 实例对象
     */
    public Map<String, Object> updateById(Hosts hosts) {
        this.hostsMapper.updateById(hosts);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 200);   // 前端端分离时，前端人员会首先判断code值是否满足200，如果不是200，则提醒用户失败
        map.put("msg", "更新成功");
        return map;
     ...
     * @return 是否成功
     */
    public Map<String, Object> deleteById(String hostId) {
        this.hostsMapper.deleteById(hostId);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 200);   // 前端端分离时，前端人员会首先判断code值是否满足200，如果不是200，则提醒用户失败
        map.put("msg", "删除成功");
        return map;
